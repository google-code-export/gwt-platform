...
public abstract class AbstractDispatch implements Dispatch {
    ...
    /**
     * Every single action will be executed by this function and validated by
     ...
     * @param ctx
     *            The {@link ExecutionContext} associated with the
     *            {@link Action}
    ...
    private <A extends Action<R>, R extends Result> SecureSessionValidator findSecureSessionValidator(A action) throws UnsupportedActionException {
        SecureSessionValidator secureSessionValidator = getSecureSessionValidatorRegistry().findSecureSessionValidator(action);
