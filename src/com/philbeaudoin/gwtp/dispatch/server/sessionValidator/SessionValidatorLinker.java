...
/**
 * This class links any registered {@link SessionValidator} instances with
    ...
    public static void linkValidators(Injector injector, SessionValidatorRegistry registry) {
        ...
        if (registry instanceof InstanceSessionValidatorRegistry) {
            ...
            for (Binding<SessionValidatorMap> binding : bindings) {
                Class<? extends SessionValidator> secureSessionValidatorClass = binding.getProvider().get().getSecureSessionValidatorClass();
                SessionValidator secureSessionValidator = injector.getInstance(secureSessionValidatorClass);
